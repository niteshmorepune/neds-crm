...
This archives older entries from CLAUDE.md's "Decisions log" section, moved out on 2026-09-09 to keep CLAUDE.md under the auto-loaded context size limit. Entries here are in the same format and chronological order as before — nothing was summarized or dropped, only relocated.

See `CLAUDE.md` for the current spec and the most recent decisions (2026-08-26 onward).
