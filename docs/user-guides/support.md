...
You handle **tickets** (client issues) and **projects & tasks** (delivery work).
...
- **Your Productivity This Month** — your rank among other Support staff
  ...
  based on your own numbers — if you have a monthly target set (below), the
  tip is built around exactly how much you need to close the gap, not just
  a general nudge.
- **Your target this month** — a progress bar against your monthly **tickets
  resolved** target, if Admin/Manager has set one for you (Team Targets page).
...
- Tick **Internal note** to leave a note only staff can see (not emailed).
- If AI is enabled, **Draft with AI** writes a suggested reply from the
  conversation — edit it before sending. **Summarize thread** gives you a quick
  recap of a long ticket.
...
- Attach files to a task when needed.
