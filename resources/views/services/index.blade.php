<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <p class="text-xs text-gray-400">Looking for the default SAC/HSN code or invoice numbering? That's moved to <a href="{{ route('billing-settings.index') }}" class="text-indigo-600 hover:underline">Billing Settings</a>.</p>
