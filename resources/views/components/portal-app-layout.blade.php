...
@php
    ...
    $navLinks = [
        ...
        [
            ...
            'route'   => 'portal.faq',
            'pattern' => 'portal.faq',
            'icon'    => '<svg fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.812.394-1.451 1.088-1.451 1.996v.25m0 3.75h.008v.008H12v-.008zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',
        ],
    ];
@endphp
