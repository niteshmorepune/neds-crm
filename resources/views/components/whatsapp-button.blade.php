@props([
    'message' => 'Hi, I need after-sale support.',
...
@if (config('services.wadesk.support_number'))
    ...
    <a href="{{ $url }}"
       ...
       {{ $attributes->merge(['class' => 'inline-flex items-center gap-2 rounded-lg bg-green-500 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-600 transition-colors ' . $class]) }}>
        <svg style="width:18px;height:18px;shrink:0" viewBox="0 0 24 24" fill="currentColor">
