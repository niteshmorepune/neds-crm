<div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
    <div class="rounded-lg bg-white p-5 shadow-sm">
        ...
        <div class="mt-3">
            <a href="{{ route('leads.index') }}" class="text-sm text-indigo-600 hover:underline">View leads →</a>
        </div>
    </div>
    <div class="rounded-lg bg-white p-5 shadow-sm">
        ...
        <div class="mt-3">
            <a href="{{ route('calls.index') }}" class="text-sm text-indigo-600 hover:underline">View calls →</a>
        </div>
    </div>
    <div class="rounded-lg bg-white p-5 shadow-sm">
