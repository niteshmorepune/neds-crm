        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-sm">
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                <thead class="bg-gray-50 text-left text-xs font-medium uppercase tracking-wide text-gray-500">
                    <tr><th class="px-4 py-3">When</th><th class="px-4 py-3">By</th><th class="px-4 py-3">Regarding</th><th class="px-4 py-3">Direction</th><th class="px-4 py-3">Outcome</th><th class="px-4 py-3">Mins</th><th class="px-4 py-3">Notes</th></tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                    ...
                    @empty
                        <tr><td colspan="6" class="px-4 py-10 text-center text-gray-400">No calls logged.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
