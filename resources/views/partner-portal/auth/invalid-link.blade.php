<x-partner-portal-guest-layout>
    ...
    <div class="mt-6 rounded-md bg-amber-50 border border-amber-200 px-3 py-2 text-sm text-amber-800">
        ...
        your NEDS contact and ask them to resend your partner portal invitation.
    </div>

    <a href="{{ route('partner-portal.password.forgot') }}"
    ...
    <p class="mt-4 text-center text-sm text-gray-500">
        <a href="{{ route('partner-portal.login') }}" class="text-indigo-600 hover:text-indigo-500">Back to sign in</a>
    </p>
</x-partner-portal-guest-layout>
