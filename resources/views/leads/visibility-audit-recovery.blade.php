<x-app-layout>
    <x-slot name="header">Visibility Audit Recovery</x-slot>
    ...
    <div class="max-w-5xl mx-auto space-y-6">
        <div class="rounded-lg border border-indigo-200 bg-indigo-50 p-4 text-sm text-indigo-900">
            ...
            <span class="block mt-1 text-xs text-indigo-700">
                Only covers leads who clicked through from the offer page itself — leads who filled Meta's lead form but never clicked through aren't tracked here yet.
            </span>
        </div>
