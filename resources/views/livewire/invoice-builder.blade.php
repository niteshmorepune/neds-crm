...
<div class="max-w-6xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-xl font-semibold text-gray-900">Edit Invoice</h1>
        <a href="{{ route('invoices.show', $invoiceId) }}" class="text-sm text-gray-500 hover:text-gray-700">Back</a>
    </div>
        ...
        <div class="w-full lg:flex-1 min-w-0 space-y-6">
            ...
            <div class="rounded-lg bg-white p-6 shadow-sm grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                    ...
                    <x-text-input wire:model="due_date" type="date" class="mt-1 block w-full" />
                </div>
            </div>
