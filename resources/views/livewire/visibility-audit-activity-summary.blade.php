    ...
    @if ($aiEnabled)
        <div class="mb-3 flex items-center justify-between">
            <button type="button" wire:click="generate" wire:loading.attr="disabled" wire:target="generate"
                ...
                <span wire:loading.remove wire:target="generate">✨ AI Activity Summary</span>
        ...
        @if (! is_null($summary))
            <div class="mb-4 rounded-md border border-indigo-200 bg-indigo-50 p-4">
                <div class="flex items-start justify-between gap-3">
                    <h3 class="text-xs font-semibold uppercase tracking-wide text-indigo-700">AI activity summary — after hours &amp; team gaps</h3>
