...
<html lang="en">
    ...
    <body class="font-sans text-gray-900 antialiased bg-white">
        ...
        <section class="max-w-2xl mx-auto px-4 py-14">
            <div class="border border-gray-200 rounded-xl p-6 sm:p-8 text-center">
                <h2 class="text-lg font-semibold text-gray-900 mb-4">Google Business Profile Visibility Check</h2>
                <ul class="space-y-2 text-gray-600 text-sm">
                    <li class="flex gap-2 justify-center"><svg class="w-5 h-5 flex-shrink-0 text-blue-600" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd" /></svg> Profile completeness</li>
        ...
        <section id="pricing" class="bg-gray-50 border-y border-gray-100 scroll-mt-6">
            <div class="max-w-md mx-auto px-4 py-14 text-center">
                ...
                <p class="text-center text-gray-500 text-[11px] sm:text-sm mt-6 whitespace-nowrap">
                    Secure payment via Razorpay &middot; GST invoice included &middot; Priced in INR
                </p>
            </div>
        </section>

        {{-- Sample Report — illustrative mockup only, not a screenshot of a
             real client's report. Clearly labelled as a sample so it's never
             mistaken for an actual result. --}}
        <section class="max-w-5xl mx-auto px-4 pb-14">
            <div class="max-w-sm mx-auto bg-white border border-gray-200 rounded-xl shadow-lg p-5 text-left">
