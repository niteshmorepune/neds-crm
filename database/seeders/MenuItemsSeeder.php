...
class MenuItemsSeeder extends Seeder
{
    ...
    public function __construct()
    {
        ...
        $this->items = [
            ...
            ['key' => 'visibility-audit-funnel', 'label' => 'Offer Funnel Analytics', 'group' => MenuGroup::TeamInsights,   'route' => 'reports.visibility-audit-funnel', 'icon' => 'funnel', 'roles' => [UserRole::Manager]],
